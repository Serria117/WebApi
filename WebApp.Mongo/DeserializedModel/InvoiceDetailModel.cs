...
{
    [JsonProperty("ttruong", NullValueHandling = NullValueHandling.Ignore)]
    public string? Ttruong { get; set; }

    [JsonProperty("kdlieu", NullValueHandling = NullValueHandling.Ignore)]
    public string? Kdlieu { get; set; }

    [JsonProperty("dlieu", NullValueHandling = NullValueHandling.Ignore)]
